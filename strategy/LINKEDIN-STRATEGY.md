...
**Prepared:** March 2026
**For:** Zack Glick / BOCC Leadership
**Platform:** LinkedIn Company Showcase Page + Zack Glick Personal Profile
...
2. [Company/Showcase Page Optimization](#2-companyshowcase-page-optimization)
3. [Content Pillars and Themes](#3-content-pillars-and-themes)
4. [Content Format Recommendations](#4-content-format-recommendations)
5. [Posting Frequency and Cadence](#5-posting-frequency-and-cadence)
6. [Thought Leadership: Zack Glick's Personal Profile](#6-thought-leadership-zack-glicks-personal-profile)
7. [Community Advocacy Program](#7-community-advocacy-program)
8. [LinkedIn Events Strategy](#8-linkedin-events-strategy)
9. [Hashtag Strategy](#9-hashtag-strategy)
10. [4-Week Sample Content Calendar](#10-4-week-sample-content-calendar)
11. [Engagement Tactics](#11-engagement-tactics)
12. [Sponsor/Partner Highlighting Strategy](#12-sponsorpartner-highlighting-strategy)
13. [B2B Positioning for Sponsorship Acquisition](#13-b2b-positioning-for-sponsorship-acquisition)
14. [Cross-Promotion with Instagram and Facebook](#14-cross-promotion-with-instagram-and-facebook)
15. [Metrics to Track](#15-metrics-to-track)
...
**What it is:** Weekly content tied directly to what happened at BOCC that Tuesday.
**Why it works:** Creates a reliable content rhythm, gives followers a reason to check in weekly, and provides social proof that the event is alive and active.
**Content types:** Recap posts, attendee spotlights, "Gives and Asks" highlights, photos from the morning.

### Pillar 2: Founder Stories (20% of content)
**What it is:** Profiles of BOCC community members -- their businesses, their journeys, what they are building.
**Why it works:** Positions BOCC as the place where real businesses get built. Gives the featured person a reason to share the post with their network, expanding reach organically.
**Content types:** Mini-profiles, "how we met at BOCC" stories, before/after narratives.

### Pillar 3: Buffalo Ecosystem (15% of content)
**What it is:** Content about Buffalo's broader startup/business ecosystem -- events, resources, trends, wins.
**Why it works:** Positions BOCC as the connective tissue of the community, not just another event. Makes the page valuable even to people who have never attended.
**Content types:** Resource roundups, ecosystem news, partner event mentions.

### Pillar 4: Community Philosophy (15% of content)
**What it is:** Content about why BOCC works the way it does -- the "gives before asks" model, the anti-sales culture, the value of weak ties, why showing up matters.
**Why it works:** Differentiates BOCC from every other networking event. Attracts the right people and repels the wrong ones.
**Content types:** Opinion posts, "here's why we do it this way" explainers, Zack's perspective pieces.

### Pillar 5: Sponsor Value (10% of content)
**What it is:** Content that demonstrates what sponsors get -- attendee engagement, community goodwill, brand visibility.
**Why it works:** Creates a public record of sponsorship value that prospective sponsors can discover. Makes current sponsors feel appreciated.
**Content types:** Sponsor spotlights, impact data, "thank you" posts.
...
- One thought per paragraph, max 2-3 lines
- White space between every paragraph
- End with a question or specific CTA that invites a reply
- No external links in the body (always "link in comments")
...
**Photo guidelines:**
- Candid shots of people in conversation (not posed group photos)
- Close-ups of coffee, name tags, the Seneca One lobby
- Always include a substantive caption -- the photo gets the click, the text gets the engagement
- Tag people in the photo when relevant and with permission

### Carousels / Document Posts (10% of total output)
High dwell-time format. Use sparingly but strategically for evergreen content.

**Best for:**
- "What to expect at your first BOCC" (onboarding new attendees)
- "5 connections that started at Tuesday morning coffee" (social proof)
- "The BOCC guide to a great 20-second pitch" (practical value)
- Year-in-review data
...
**Good poll examples:**
- "What's the hardest part of networking as a founder?" (validates BOCC's value)
- "How did you find your first customer?" (relevant to the audience)
- "What time works better for you: 7:30 AM or 12 PM?" (practical feedback)
...
**Best for:**
- 30-second "vibe check" from a Tuesday morning (ambient crowd noise, coffee, conversations)
- Quick attendee testimonials filmed at the event ("Why do you keep coming back?")
- Zack doing a 60-second "what happened this Tuesday" recap
...
**Why these times:**
- Tuesday at lunch: People who attended that morning are still buzzing. They will comment. People who missed it see what they missed.
- Wednesday/Thursday morning: Peak LinkedIn engagement window. Professional audience is active.
- Friday late morning: Lighter content, planning-for-next-week energy.
...
**Angle 1: Community Builder Diary (40%)**
Behind-the-scenes of running BOCC. The real stuff -- what went well, what flopped, what surprised him. This is the content that builds connection and trust.
...
**Angle 2: Entrepreneurship in Buffalo (30%)**
Takes on what it means to build a business in Buffalo specifically -- the advantages, the gaps, the culture. Positions Zack as someone who thinks about the ecosystem, not just his event.
...
**Angle 3: Lessons from Cybersecurity/Big Tech Applied to Community (30%)**
Zack's unique angle -- he is not a lifelong community organizer. He is a cybersecurity engineer who chose to build community. That tension is interesting and differentiating.
...
- Respond to every comment on his posts within the first 60 minutes
- Leave 3-5 substantive comments per day on posts from BOCC community members, Buffalo business leaders, and potential sponsors
- When a community member posts about BOCC organically, Zack comments AND reshares with added context from the BOCC page
...
- Who has posted about BOCC organically
- When they posted
- How many times
- Whether the BOCC page reshared
- Whether Zack commented
...
**Event title:** "Buffalo Open Coffee Club -- Free Tuesday Networking"
**Frequency:** Weekly
**Description:** Mirror the "What to Expect" section from the website, adapted for LinkedIn's format.
...
- **2 weeks before:** Create event, post announcement
- **1 week before:** Reminder post with venue photo
- **Day of:** "See you at 4 PM" morning post
- **Day after:** Recap post with photos
...
- Always include `#BOCC` -- own the abbreviation
- Always include at least one Buffalo-specific hashtag
- Place hashtags at the bottom of the post, separated by a line break
- Never use generic hashtags like `#Motivation` or `#Success`
- Never hashtag-stuff the first line of a post
...
**Tuesday (BOCC Page, 12 PM)**
*Pillar: Tuesday Pulse*
```
...
**Wednesday (Zack's Profile, 8 AM)**
*Angle: Community Builder Diary*
```
...
**Thursday (Zack's Profile, 8 AM)**
*Angle: Entrepreneurship in Buffalo*
```
...
**Friday (BOCC Page, 10 AM)**
*Pillar: Buffalo Ecosystem + Afternoon Edition Promotion*
```
...
**Wednesday (Zack's Profile, 8 AM)**
*Angle: Lessons from Big Tech Applied to Community*
```
...
**On BOCC Page Posts:**
- Zack personally responds to every comment within 60 minutes of posting
- Responses are substantive, not performative. "Thanks!" is not a response. "That reminds me of what [Name] shared at last week's Gives and Asks -- you two should connect" is a response.
- When someone comments who has never attended, Zack's response includes a soft invitation: "Would love to see you on a Tuesday. Registration is free -- I'll make sure to introduce you around."

**On Other People's Posts (Proactive Engagement):**
Zack and any BOCC volunteers should comment on 5-10 posts per day from:
- BOCC community members (supporting their content)
- Buffalo business leaders and ecosystem builders
- Potential sponsors and their company pages
- Local media, economic development orgs, universities
...
**When to tag people:**
- In attendee spotlight posts (with their permission)
- When resharing someone's organic BOCC post
- When referencing a specific person's "Give or Ask" from Tuesday (with permission)
- When crediting Jack Greco and Clark Dever for BOCC's founding

**When NOT to tag:**
- Mass-tagging attendees in a recap post (this is spam)
- Tagging potential sponsors in promotional content (this is cold outreach in public)
- Tagging people you haven't interacted with to get their attention
...
- Mention sponsors naturally in Tuesday recap posts: "Coffee provided by [Sponsor] -- as always"
- Include sponsor in the Eventbrite description
- Feature sponsor logo in carousel content where appropriate (not forced)
- When a sponsor's team member attends BOCC, highlight their participation naturally

### Sponsor Content for Their Channels
...
**Step 1: Identify**
Build a target list of 20-30 companies that serve entrepreneurs and small businesses in WNY:
- Banks and credit unions (community banking)
- Law firms (business formation, IP)
- Accounting firms (tax, bookkeeping)
- Insurance agencies
- Co-working spaces
- Marketing agencies
- Tech companies with WNY offices
- Local coffee roasters and food brands

**Step 2: Warm**
Before any outreach, Zack engages with the company's LinkedIn content for 2-4 weeks:
- Comment on their posts substantively
- Share their relevant content with added commentary
- Connect with decision-makers using personalized requests that reference specific content

**Step 3: Soft Pitch**
After establishing comment presence, DM the decision-maker:
...
**Step 4: Social Proof Follow-up**
If the prospect is interested but hasn't committed, send them:
- 2-3 of the organic LinkedIn testimonials from community members
- The sponsorship page link (716coffee.club/sponsorship/)
- A recent Tuesday recap post showing real engagement
...
- "32 attendees this week"
- "14 freelancer-client connections in 3 months"
- "50:50 men and women"
- "Students from UB, Buffalo State, and Canisius"
...
- "More photos from this morning on our Instagram -- @buffaloopencoffeeclub"
- Repurpose Instagram Reels as LinkedIn native video (re-upload, do not link)

**Instagram to LinkedIn:**
- "Full founder spotlight on our LinkedIn -- link in bio"
- Share LinkedIn post screenshots in Instagram Stories with "Read the full story" prompt

**Facebook to LinkedIn:**
- Share LinkedIn event links in the Facebook group/page
- Repost LinkedIn content natively on Facebook (do not cross-link)

**LinkedIn to Facebook:**
- Minimal. LinkedIn audience does not need to be driven to Facebook.
...
- LinkedIn native analytics (Page Admin > Analytics)
- LinkedIn personal profile analytics (Zack's dashboard)
- Simple spreadsheet tracking weekly post performance, community posts, and sponsor pipeline
- Eventbrite registration data cross-referenced with "How did you hear about us?" check-in question
...
### On-Voice
- "32 people showed up before most of Buffalo hit snooze."
- "No agenda except help each other."
- "Gives before asks. That's the rule."
- "She almost didn't come. She's glad she did."
- "Free. Every Tuesday. That's it."

### Off-Voice
- "We're thrilled to announce another successful networking event!"
- "BOCC is a premier professional development opportunity."
- "Join our exclusive community of thought leaders."
- "We're disrupting the networking space."
- "Like and share if you agree that community matters!"
...
- "Value-add"
- "Thought leader" (show it, never say it)
- "Exclusive" (BOCC is the opposite of exclusive)
- Any variation of "we're not just a networking event, we're a movement"

---

## Appendix C: First 30 Days Action Checklist

- [ ] Update BOCC showcase page tagline and description (Section 2)
- [ ] Update Zack's LinkedIn headline and About section (Section 6)
- [ ] Get or take a real event photo for the BOCC page banner
- [ ] Pin 3 items to the BOCC Featured section
- [ ] Pin 3 items to Zack's Featured section
- [ ] Create first LinkedIn Event for next Tuesday
- [ ] Post the first Tuesday recap using the template
- [ ] Deliver the Tuesday Post Prompt at next week's event
- [ ] Identify 20 target sponsor companies and begin engaging
- [ ] Set up the tracking spreadsheet (post performance + community posts + sponsor pipeline)
- [ ] Establish the daily comment habit: 5 substantive comments before posting
- [ ] Take 5-10 photos at each Tuesday event for content pipeline
- [ ] Create the "What to Expect at Your First BOCC" carousel
