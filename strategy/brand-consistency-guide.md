...
- "Buffalo's builders"
- "Gives and Asks" (always capitalize -- it is the name of our format)
- "The community"
- "Grab a name tag"
- "No hard out"
- "Come ready to meet people, not to sell"
- "Every Tuesday morning"
- "Free" (always mention -- it is a differentiator)
- "Entrepreneurs, small business owners, founders"
- "Chill" / "low-key" / "no-frills"
...
- **Sentence case** for headlines and captions, not Title Case (except "Gives and Asks," "Afternoon Edition," "Buffalo Open Coffee Club")
- **Use contractions** -- "we're" not "we are," "don't" not "do not." Formal language feels wrong for BOCC.
- **Time format**: "7:30 AM" (with space, caps AM/PM) or "7:30-9 AM" for ranges
- **Abbreviation**: "BOCC" is acceptable after first use of "Buffalo Open Coffee Club" in any piece of content. On Instagram captions, leading with "BOCC" alone is fine since the account name provides context.
- **Emoji use**: Sparingly. Coffee cup, sunrise/sun, and buffalo are on-brand. Avoid excessive emoji strings. One or two per caption maximum on Instagram. Zero to one on LinkedIn. Facebook can match Instagram.
- **Hashtags**: See Section 6 below.
...
**Logo rules:**
- Never stretch, rotate, or apply filters to either logo
- The mug icon works at small sizes; the full badge needs space -- do not shrink it below where "716" is legible
- On light backgrounds, use the logos as-is. On dark backgrounds, the full badge already has a dark background built in. The mug icon can be used in white/reversed if needed for dark contexts
- Minimum clear space around either logo: the width of the mug handle on all sides
...
- **Primary pair**: Deep brown (`#361b01`) + amber gold (`#f2a63a`) -- this is the core BOCC look
- **Background**: Warm cream (`#fdf8f3`) or white
- **Accent pop**: Buffalo brick red (`#b22030`) for calls to action
- **Avoid**: Cool blues, neon greens, purples, or any color that reads "corporate tech." If in doubt, ask: "Does this look like it belongs in a coffee shop?" If not, pull it back.
...
- Slight warmth boost is fine and on-brand
- Avoid heavy filters or presets that change the color temperature dramatically
- Crop to focus on people and interactions, not empty space
- Vertical crops for Instagram Stories and Reels, square or 4:5 for feed posts, landscape for Facebook and LinkedIn

### Typography direction

The website uses system/theme fonts from Minimal Mistakes (sans-serif stack). For social media graphics:

- **Headlines**: A bold, clean sans-serif. Nothing script, nothing overly decorative. The brand is approachable, not fancy.
- **Body text**: A readable sans-serif at a comfortable size.
- **Avoid**: Script fonts, all-caps body text, overly thin weights that are hard to read on mobile.
- **If creating branded templates**: Choose one sans-serif family and use weight variations (bold for headlines, regular for body, semi-bold for emphasis). Consistency in font choice across all graphics is more important than which specific font is chosen.
...
- 501(c)(3) nonprofit backing through BootSector
- 50/50 gender split (organically, not by design)
- University student engagement (Buffalo State, Canisius, UB)
- Gives and Asks format is unique -- people help each other, not pitch each other
- The Afternoon Edition is expanding the format to new times and locations
...
- **Show real people, real moments.** The best BOCC content is a photo from that morning with a genuine caption about what happened.
- **Credit and tag community members.** BOCC exists because of its people. Spotlight them by name (with permission).
- **Mention that it is free.** Every. Single. Time. This is the most common thing new people want to know, and it is the strongest differentiator from paid networking events.
- **Include the basics for new people.** At least once a week across platforms, spell out: every Tuesday, 7:30-9 AM, Seneca One lobby, free.
- **Share the origin story periodically.** The 2010 roots give BOCC credibility and depth. New followers need to hear this.
- **Celebrate Afternoon Edition as part of the family.** Same energy, different time and place.
- **Amplify attendee-generated content.** When someone posts about BOCC on their own account, reshare it. This is the highest-value content -- it is authentic and extends reach through their network.
- **Acknowledge sponsors naturally.** Mention them in the context of what they make possible, not as ad reads.
- **Post consistently.** A minimum baseline of one post per platform per week. Tuesday morning recaps are the anchor content.

### Do not

- **Do not hard-sell anything.** BOCC's entire identity is built on being anti-pitch. Content should never feel like a sales funnel.
- **Do not post stock photography.** Ever. If there are no photos from a specific week, use a previous week's photo with honest context, or post text-only.
- **Do not use other organizations' branding without permission.** This includes sponsor logos in contexts they have not approved.
- **Do not post political content or take political positions.** BOCC is a nonpartisan community space.
- **Do not overpromise.** "You WILL find your next business partner" is not BOCC's style. "You might meet someone who changes your trajectory" is closer to the truth.
- **Do not ignore negative feedback.** If someone has a bad experience or raises a concern publicly, respond promptly, empathetically, and in alignment with the Code of Conduct.
- **Do not create FOMO-driven content.** "Only 5 spots left!" contradicts the open, free, everyone-welcome ethos. If Eventbrite tickets genuinely run out, say so matter-of-factly and explain how to still attend.
- **Do not post without proofreading.** Typos in the brand name, wrong times, or broken links undermine trust. Double-check every post.
- **Do not forget the Afternoon Edition.** It should appear in content at least twice a month leading up to each event.
...
- **Instagram**: Use 5-10 hashtags total. Place the three primary hashtags in the caption, additional hashtags in a comment or after a line break.
- **Facebook**: Use 1-3 hashtags maximum. More than that looks spammy on Facebook. Stick to primary tags.
- **LinkedIn**: Use 3-5 hashtags. Place at the end of the post. Include `#BuffaloOpenCoffeeClub` and 2-3 relevant secondary/industry tags.
- **Never invent one-off hashtags** for individual posts. Consistency builds discoverability.
- **Encourage attendees** to use `#BuffaloOpenCoffeeClub` and `#BOCC` on their own posts.
...
Category: Community Organization or Networking Event
...
- [ ] Mention "free" explicitly
- [ ] Say "every Tuesday" (not "weekly" alone -- the day matters)
- [ ] Include the time (7:30-9 AM)
- [ ] Name the location (Seneca One Tower)
- [ ] Link to 716coffee.club or the Eventbrite registration
- [ ] Mention BootSector 501(c)(3)
- [ ] Avoid outdated information (old locations, old times, discontinued events)
- [ ] Match the current event format (update if Gives and Asks format changes)
...
- **Review this guide quarterly.** As the community evolves, the voice may need to evolve too -- but changes should be deliberate, not accidental drift.
- **Onboard any new content contributors** with this document. Do not assume anyone will intuit the voice.
- **Audit cross-platform consistency monthly.** Compare the last four posts on each platform side by side. Do they look and sound like they come from the same organization? If not, recalibrate.
- **Protect the anti-corporate identity actively.** Growth creates pressure to formalize. Resist language like "our brand," "our content strategy," "audience engagement" in external-facing content. That language is for internal documents (like this one). Externally, BOCC just talks to people.
- **When in doubt, choose warmth over polish.** A slightly imperfect photo with a genuine caption will always outperform a designed graphic with generic copy. The imperfection is part of the charm.
